...
parser.add_argument("--save_freq", type=int, default=14180, help="save model every save_freq steps, 0 to disable")
        ...
        if a.mode == "test":
            ...
            for step in range(max_steps):
                ...
                if should(a.save_freq):
                    print("saving model")
                    if train_epoch%10==0:
                        name_to_save = "model_" + str(train_epoch)
                        saver.save(sess, os.path.join(a.output_dir, name_to_save), global_step=sv.global_step)
